    ...
    <header>
        <div class="header-container">
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a class="nav-link" href="souvenir.php" style="color: #a58f78 !important;">հուշանվեր</a>
                        </li>
                        <li class="nav-item">
                ...
                <a style="margin-left:20px" href="eng/souvenir.php"><img src="assets/images/englishFlag.png" /></a>
            </nav>
        </div>
    </header>
                    ...
                    <div class="flip-box">
                        <div class="flip-box-inner">
                            ...
                            <div class="flip-box-back">
                                <div class="collection-coin">
                                    <img id="col-<?php echo $collection_desc['id'] + 1 ?>"
                                        src="assets/images/collection/<?php echo $collection_desc['seccond_image'] ?>">
                                </div>
                            </div>
                        </div>
