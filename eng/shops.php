                    ...
                    <div class="col-md-12 row pt-15">
                        <div class="col-md-4 pb-30">
                            <div class="collection-picture">
                                <div class="pic" style="background-image: url(../assets/images/shop/<?php echo $packagingInfo['image'] ?>);">
                                    <div class="ic">
                                        <div class="ic1">
                                            <a data-fancybox="gallery" href="../assets/images/shop/<?php echo $packagingInfo['image'] ?>" data-options='{"thumbs" : false}'><img src="../assets/images/shop/zoom_icon.png" alt="" class="zoom"></a>
                                        </div>
                                    </div>
                                    <div class="hidden">
